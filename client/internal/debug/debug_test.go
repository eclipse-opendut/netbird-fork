...
func TestAddConfig_AllFieldsCovered(t *testing.T) {
	...
	cfg := &profilemanager.Config{
		...
		IDPClientCert:                 profilemanager.MTLSConfig{CertPath: "/tmp/cert", KeyPath: "/tmp/key"},
		MgmtClientCert:                profilemanager.MTLSConfig{CertPath: "/tmp/mgmt-cert", KeyPath: "/tmp/mgmt-key"},
		LazyConnection:                "on",
