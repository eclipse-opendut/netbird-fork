...
func (a *Auth) saveConfigIfSSOSupported() (bool, error) {
	...
	err := a.withBackOff(a.ctx, func() (err error) {
		clientCert := a.config.ClientCertKeyPair
		_, err = internal.GetPKCEAuthorizationFlowInfo(a.ctx, a.config.PrivateKey, a.config.ManagementURL, clientCert)
		if s, ok := gstatus.FromError(err); ok && (s.Code() == codes.NotFound || s.Code() == codes.Unimplemented) {
			_, err = internal.GetDeviceAuthorizationFlowInfo(a.ctx, a.config.PrivateKey, a.config.ManagementURL, clientCert)
